 ...
 */
package org.example.sentineldemo.flow;
...
/**
 * When  set to {@link RuleConstant#CONTROL_BEHAVIOR_WARM_UP}, real passed qps will
 * gradually increase to , other than burst increasing.
 * <p/>
...
public class WarmUpFlowDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("============ first make the system run on a very low condition ============");
        for (int i = 0; i < 3; i++) {
